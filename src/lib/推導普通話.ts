...
const 推導普通話 = (當前音韻地位: 音韻地位): string => {
    ...
    const { 聲母, 解釋 } = when(
      [
        ...
        [
          '並母',
          [
            ['平聲', { 聲母: 'p', 解釋: '並母 平聲推導為聲母 p' }],
            ['', { 聲母: 'b', 解釋: '並母 非平聲推導為聲母 b' }],
          ],
        ],
        [
          '明母',
          [
            ['C類', { 聲母: 'w', 解釋: '明母 C類推導為聲母 w' }],
            ['', { 聲母: 'm', 解釋: '明母 非C類推導為聲母 m' }],
          ],
        ],
        ...
        [
          '定母',
          [
            ['平聲', { 聲母: 't', 解釋: '定母 平聲推導為聲母 t' }],
            ['', { 聲母: 'd', 解釋: '定母 非平聲推導為聲母 d' }],
          ],
        ],
        ...
        [
          '從母',
          [
            ['平聲', { 聲母: 'c', 解釋: '從母 平聲推導為聲母 c' }],
            ['', { 聲母: 'z', 解釋: '從母 非平聲推導為聲母 z' }],
          ],
        ],
        ['心邪母', { 聲母: 's', 解釋: '心邪母推導為聲母 s' }],
        ['知莊章母', { 聲母: 'zh', 解釋: '知莊章母推導為聲母 zh' }],
        ['徹初昌母', { 聲母: 'ch', 解釋: '徹初昌母推導為聲母 ch' }],
        [
          '澄崇母',
          [
            ['平聲', { 聲母: 'ch', 解釋: '澄崇母 平聲推導為聲母 ch' }],
            ['', { 聲母: 'zh', 解釋: '澄崇母 非平聲推導為聲母 zh' }],
          ],
        ],
        [
          '常母',
          [
            ['平聲 陽聲韻', { 聲母: 'ch', 解釋: '常母 平聲 且 陽聲韻 推導為聲母 ch' }],
            ['', { 聲母: 'sh', 解釋: '常母 非(平聲 且 陽聲韻) 推導為聲母 sh' }],
          ],
        ],
        ['生書母', { 聲母: 'sh', 解釋: '生書母推導為聲母 sh' }],
        ['俟船母', { 聲母: 'sh', 解釋: '俟船母推導為聲母 sh' }],
        ...
        [
          '羣母',
          [
            ['平聲', { 聲母: 'k', 解釋: '羣母 平聲推導為聲母 k' }],
            ['', { 聲母: 'g', 解釋: '羣母 非平聲推導為聲母 g' }],
          ],
        ],
        ['曉匣母', { 聲母: 'h', 解釋: '曉匣母推導為聲母 h' }],
        ['以母 蟹攝 三四等 合口', { 聲母: 'r', 解釋: '以母 蟹攝 三四等 合口 推導為聲母 r' }], // 「銳」
        ['疑影云以母', { 聲母: '', 解釋: '疑影云以母推導為零聲母' }],
      ],
      '無聲母規則'
    ...
    const { 韻母, 解釋 } = when(
      [
        [
          '通攝',
          [
            ['三四等 牙喉音', { 韻母: 'ü', 解釋: '通攝 三四等 且為牙喉音，推導為韻母 ü' }],
            ['', { 韻母: 'u', 解釋: '通攝 非（三四等牙喉音），推導為韻母 u' }],
          ],
        ],
        [
          '臻深攝',
          [
            ...
            [
              '三四等',
              [
                ['合口 或 脣音 C類', { 韻母: 'ü', 解釋: '臻深攝 三四等 合口 或 脣音 C類，推導為韻母 ü' }],
                ['', { 韻母: 'i', 解釋: '臻深攝 三四等 非(合口或脣音C類)，推導為韻母 i' }],
              ],
            ],
            [
              '',
              [
                ['脣音', { 韻母: 'o', 解釋: '臻深攝 非莊組 非三四等 且為脣音，推導為韻母 o' }],
                ['合口', { 韻母: 'u', 解釋: '臻深攝 非莊組 非三四等 且為合口，推導為韻母 u' }],
        ...
        [
          ...
          [
            [
              '二等 或 莊組 或 脣音 C類',
              [
                ['合口', { 韻母: 'ua', 解釋: '山咸攝 二等/莊組/脣音C類 且為合口，推導為韻母 ua' }],
                ['牙喉音', { 韻母: 'ia', 解釋: '山咸攝 二等/莊組/脣音C類 且為牙喉音，推導為韻母 ia' }],
                ['', { 韻母: 'a', 解釋: '山咸攝 二等/莊組/脣音C類 非合口 非牙喉音，推導為韻母 a' }],
              ],
            ],
            [
              '三四等',
              [
                ['合口', { 韻母: 'üe', 解釋: '山咸攝 三四等 合口，推導為韻母 üe' }],
                ['', { 韻母: 'ie', 解釋: '山咸攝 三四等 非合口，推導為韻母 ie' }],
              ],
            ],
            [
              '',
              [
                [
                  '開口',
                  [
                    ['牙喉音', { 韻母: 'e', 解釋: '山咸攝 非(二等/莊組/脣音C類) 非三四等 開口 且為牙喉音，推導為韻母 e' }],
                    ['', { 韻母: 'a', 解釋: '山咸攝 非(二等/莊組/脣音C類) 非三四等 開口 非牙喉音，推導為韻母 a' }],
                  ],
                ],
                ['', { 韻母: 'uo', 解釋: '山咸攝 非(二等/莊組/脣音C類) 非三四等 非開口，推導為韻母 uo' }],
              ],
            ],
          ],
        ],
        ...
        [
          '宕江攝',
          [
            ['三四等 或 二等 牙喉音', { 韻母: 'üe', 解釋: '宕江攝 三四等 或 二等且為牙喉音，推導為韻母 üe' }],
            ['一等 開口 牙喉音', { 韻母: 'e', 解釋: '宕江攝 一等開口牙喉音，推導為韻母 e' }],
            ['', { 韻母: 'uo', 解釋: '宕江攝 其他情況，推導為韻母 uo' }],
          ],
        ],
        ...
        [
          ...
          [
            ...
            [
              '三四等 非 莊組',
              [
                ['合口', { 韻母: 'ü', 解釋: '梗曾攝 三四等 非（莊組） 且為合口，推導為韻母 ü' }],
            ...
            [
              '',
              [
                ['開口', { 韻母: 'e', 解釋: '梗曾攝 非（三四等 非（莊組）） 且為開口，推導為韻母 e' }],
    ...
    const { 聲調, 解釋 } = when(
      [
        [
          '清音',
          [
            ['平聲', { 聲調: '1', 解釋: '清音平聲推導為第 1 聲（普通話陰平）' }],
            ['上聲', { 聲調: '3', 解釋: '非全濁上聲推導為第 3 聲（普通話上聲）' }],
            ['去聲', { 聲調: '4', 解釋: '去聲推導為第 4 聲（普通話去聲）' }],
        ...
        [
          '濁音',
          [
            ['平聲', { 聲調: '2', 解釋: '濁音平聲推導為第 2 聲（普通話陽平）' }],
            [
              '上聲',
              [
                ['全濁', { 聲調: '4', 解釋: '全濁上聲變為去聲（全濁上變去），故推導為第 4 聲（普通話去聲）' }],
                ['次濁', { 聲調: '3', 解釋: '非全濁上聲推導為第 3 聲（普通話上聲）' }],
              ],
            ],
            ['去聲', { 聲調: '4', 解釋: '去聲推導為第 4 聲（普通話去聲）' }],
            [
              '入聲',
              [
                ['全濁', { 聲調: '2', 解釋: '全濁入聲推導為第 2 聲（普通話陽平）' }],
                ['次濁', { 聲調: '4', 解釋: '次濁入聲推導為第 4 聲（普通話去聲）' }],
              ],
            ],
          ],
        ],
  ...
  if (韻母 === 'er') {
    if (聲母 === 'r') {
      聲母 = '';
      defaultLogger.log('韻母為 er，將聲母 r 改為零聲母');
    } else {
      韻母 = 'i';
      defaultLogger.log('韻母為 er，聲母非 r，故將韻母改為 i');
    }
  }
  ...
  if (['b', 'p', 'm', 'f', 'w'].includes(聲母) && 韻母[0] === 'u' && 韻母[1]) {
    韻母 = 韻母.slice(1);
    defaultLogger.log('聲母為 b/p/m/f/w，韻母不為 u，而韻母首字母為 u 時，去除韻母首字母 u')
  }
  ...
  return 聲母 + (聲調 ? 韻母.replace(/.*a|.*[eo]|.*[iuü]/, '$&' + ' ̄́̌̀'[parseInt(聲調, 10)]) : 韻母);
};
